    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="bg-foreground text-background py-12 md:py-16">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-2xl md:text-4xl font-display font-bold mb-3">Onboarding</h1>
      ...
      <footer className="bg-foreground text-background py-6">
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex flex-col md:flex-row items-center gap-4 text-sm">
              <a href="tel:1-888-524-7678" className="flex items-center gap-2 hover:text-primary transition-colors">
                <Phone className="w-4 h-4" />
                1-888-524-7678
              </a>
              <a href="mailto:info@kairossecurity.com" className="flex items-center gap-2 hover:text-primary transition-colors">
          ...
          <div className="flex flex-col items-center gap-2 mt-4">
            <p className="text-center text-sm text-background/60">© 2026 Kairos Security. All rights reserved.</p>
            <a href="/admin" className="text-xs text-background/40 hover:text-background/60 transition-colors">Admin</a>
          </div>
        </div>
      </footer>
    </div>
